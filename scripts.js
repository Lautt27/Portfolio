...
document.addEventListener("DOMContentLoaded", () => {
        ...
        en: {
            ...
            projects: {
                ...
                project1: {
                    ...
                    description: "A web project that uses HTML, PHP, and Bootstrap to create an interactive application.",
                },
                project2: {
                    title: "Teatro Opera",
                    description: "This is a project where I update the website of Teatro Opera using HTML, PHP, JavaScript, and CSS.",
                },
                project3: {
                    title: "Placeholder Project",
                    description: "An additional example project to showcase skills and creativity.",
                },
            },
            studies: {
                ...
                study1: {
                    ...
                    description: "I will learn to create and develop websites, integrating them with social media to enhance advertising campaigns using WordPress.",
                    span: "2025 - Present | National Technological University of Buenos Aires",
                },
                study2: {
                    title: "Higher Technician in Programming",
                    description: "A tertiary program focused on programming and algorithms, covering the principles of software design and development.",
                    span: "2024 - Present | Teclab Higher Technical Institute",
                },
                study3: {
                    title: "Microsoft Office Course",
                    description: "Developed skills in Microsoft Office applications, including Word, Excel, and PowerPoint, for creating documents, spreadsheets, and presentations.",
                    span: "2023 | ACE Morón Educational Community",
                },
                study4: {
                    title: "Programming Course",
                    description: "Learned to develop web and desktop applications using Visual Basic, HTML, PHP, and MySQL, with a focus on building dynamic, database-driven projects.",
                    span: "2019 - 2020 | ACE Morón Educational Community",
                },
            },
            footer: {
                contact: "Contact Me!",
                copyright: "© 2024 | Designed by Lautaro Casal",
            },
        },
        es: {
            header: {
            ...
            projects: {
                ...
                project1: {
                    title: "M&M Multimedia",
                    description: "Un proyecto web que utiliza HTML, PHP y Bootstrap para crear una aplicación interactiva.",
                },
                project2: {
                    title: "Teatro Opera",
                    description: "Este es un proyecto donde actualicé el sitio web del Teatro Opera usando HTML, PHP, JavaScript y CSS.",
                },
                project3: {
                    title: "Proyecto de Ejemplo",
                    description: "Un proyecto adicional para mostrar habilidades y creatividad.",
                },
            },
            studies: {
                ...
                study1: {
                    ...
                    description: "Aprenderé a crear y desarrollar sitios web, integrándolos con redes sociales para optimizar las campañas publicitarias usando WordPress.",
                    span: "2025 - Presente | Universidad Tecnológica Nacional de Buenos Aires",
                },
                study2: {
                    title: "Técnico Superior en Programación",
                    description: "Un programa terciario enfocado en programación y algoritmos, cubriendo los principios del diseño y desarrollo de software.",
                    span: "2024 - Presente | Instituto Técnico Superior Teclab",
                },
                study3: {
                    title: "Curso de Microsoft Office",
                    description: "Desarrollé habilidades en aplicaciones de Microsoft Office, incluyendo Word, Excel y PowerPoint, para crear documentos, hojas de cálculo y presentaciones.",
                    span: "2023 | Comunidad Educativa ACE Morón",
                },
                study4: {
                    title: "Curso de Programación",
                    description: "Aprendí a desarrollar aplicaciones web y de escritorio usando Visual Basic, HTML, PHP y MySQL, con un enfoque en proyectos dinámicos basados en bases de datos.",
                    span: "2019 - 2020 | Comunidad Educativa ACE Morón",
                },
            },
            footer: {
                contact: "¡Contáctame!",
                copyright: "© 2024 | Diseñado por Lautaro Casal",
            },
        },
    };
    ...
    const switchLanguage = (language) => {
        ...
        if (language === "en") {
            resumeLink.href = "assets/cv/resume.pdf";
        } else if (language === "es") {
            resumeLink.href = "assets/cv/cv.pdf";
        }
